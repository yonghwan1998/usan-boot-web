...
import com.usanmap.usan.service.OAuthUserInfoMapper;
import com.usanmap.usan.service.SocialLoginService;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        return new com.usanmap.usan.security.CustomOAuth2User(
                snap.userId(),
                snap.email(),
                snap.nickname(),
                newAttrs
